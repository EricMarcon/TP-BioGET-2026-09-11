---
title: "Comparaison de la diversité de deux forêts tropicales"
# Output formats
format:
  stylisharticle-pdf:
    keep-tex: true
...
abstract: |
  La forêt de Paracou est plus diverse que celle de Barro Colorado Island.
keywords: [Biodiversité, Forêt tropicale]
# Bibliography
...
corrauthorlabel: Auteur correspondant
---
...
- Nombres de @Hill1973.
- Profils de diversité : valeur de la diversité en fonction de son ordre [@Tothmeresz1995; @Patil1982].
...
Les enveloppes grisées représentent l'intervalle de confiance à 95% de la diversité.
:::

- La @fig-Profils montre que la forêt de Paracou est la plus diverse: les profils de diversité ne se croisent pas.
